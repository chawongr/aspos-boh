...
const StoreClients = () => {
  ...
  const columns = useMemo<ColumnDef<IStoreClientsData>[]>(
    () => [
      ...
      {
        id: 'menuItemHHT',
        header: ({ column }) => <DataGridColumnHeader title="Menu Item HHT" column={column} />,
        enableSorting: false,
        cell: ({ row }) => (
          <Checkbox
            onChange={(e) => handleCheckboxChange(e, row.original)}
      ...
      {
        id: 'masterData',
        header: ({ column }) => <DataGridColumnHeader title="Master Data" column={column} />,
        enableSorting: false,
        cell: ({ row }) => (
          <Checkbox
            onChange={(e) => handleCheckboxChange(e, row.original)}
      ...
      {
        id: 'actions',
        header: ({ column }) => <DataGridColumnHeader title="Sync Down" column={column} />,
        enableSorting: true,
        cell: () => <button className="loadBtn">Sync Down</button>,
        meta: {
      ...
      {
        id: 'actions',
        header: ({ column }) => <DataGridColumnHeader title="Initial Data" column={column} />,
        enableSorting: true,
        cell: () => <button className="loadBtn">Initial Data</button>,
        meta: {
          headerClassName: 'w-28',
          cellClassName: 'text-gray-800 font-medium'
        }
